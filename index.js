const questions = require('./main/lid/questions');
const inquirer = require("inquirer");
const cTable = require('console.table');
const db = require('./main/config/connection');

const displayTheDepartments = () => {
...
const addARole = (roleTitle, salary, departmentName) => {
...
const addAnEmployee = (firstName, lastName, roleName, employeeManager) => {
...
const updateAnEmployee = (roleId, employeeId) => {
...
const updateAnEmployeeManager = (employeeId, managerId) => {
...
const deleteADepartment = (departmentId) => {
...
const deleteAnEmployee = (employeeId) => {
        ...
        .then((answers) => {
            ...
            switch (userChoice) {
                ...
                case 'Add An Employee':
                    addAnEmployee(firstName, lastName, employeeRole, employeeManager);
                    break;
                case 'Update An Employee Role':
                    updateAnEmployee(employeeSelectionRole, employeeSelection);
                    break;
                ...
                case 'Update Employee Managers':
                    updateAnEmployeeManager(employeeSelection, employeeManager)
                    break;
                case 'Delete A Department':
                    deleteADepartment(roleDepartment);
                    break;
                case 'Delete A Role':
                    deleteARole(employeeRole);
                    break;
                case 'Delete An Employee':
                    deleteAnEmployee(employeeSelection);
                    break;
